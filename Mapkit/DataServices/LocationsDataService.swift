...
class LocationsDataService {
    ...
    static let locations: [Location] = [
        Location(
            ...
            description: "鶴岡八幡宮は、神奈川県鎌倉市にある神社。武家源氏、鎌倉武士の守護神。鎌倉初代将軍源頼朝ゆかりの神社として知られ、鎌倉の文化の起点ともなっています。",
            imageNames: [
        ...
        Location(
            ...
            description: "建長寺は、神奈川県鎌倉市にある禅宗の寺院で、臨済宗建長寺派の大本山。鎌倉五山の第一位。境内は国の史跡に指定されています。",
            imageNames: [
                "kenchoji-1",
                "kenchoji-2",
                "kenchoji-3",
        ...
        Location(
            ...
            description: "長谷寺は、神奈川県鎌倉市にある浄土宗系統の単立寺院。本尊は十一面観音。坂東三十三観音霊場の第四番札所。通称「長谷観音」。",
            imageNames: [
                "hasedera-1",
                "hasedera-2",
                "hasedera-3",
        ...
        Location(
            ...
            description: "明月院は、神奈川県鎌倉市にある臨済宗建長寺派の寺院。山号を福源山と称する。あじさい寺として知られる。",
            imageNames: [
                "meigetsuin-1",
                "meigetsuin-2",
                "meigetsuin-3",
        ...
        Location(
            ...
            description: "報国寺は、神奈川県鎌倉市にある臨済宗建長寺派の寺院。竹の庭で知られ、「竹寺」とも呼ばれる。",
            imageNames: [
                "hokokuji-1",
                "hokokuji-2",
                "hokokuji-3",
        ...
        Location(
            ...
            description: "東慶寺は、神奈川県鎌倉市にある臨済宗円覚寺派の寺院。かつては尼寺で、江戸時代には縁切寺として知られた。",
            imageNames: [
                "tokeiji-1",
                "tokeiji-2",
                "tokeiji-3",
        ...
        Location(
            ...
            description: "浄智寺は、神奈川県鎌倉市にある臨済宗円覚寺派の寺院。鎌倉五山の第四位。山号を金宝山と称する。",
            imageNames: [
                "jochiji-1",
                "jochiji-2",
                "jochiji-3",
        ...
        Location(
            ...
            description: "銭洗弁財天宇賀福神社は、神奈川県鎌倉市にある神社。境内の洞窟にある清水で硬貨などを洗うと増えるとされることから、銭洗弁天の名で知られる。",
            imageNames: [
                "zeniarai-benten-1",
                "zeniarai-benten-2",
                "zeniarai-benten-3",
        ...
        Location(
            ...
            description: "本覚寺は、神奈川県鎌倉市にある日蓮宗の本山。身延山の久遠寺にあった日蓮の遺骨を分骨したため「東身延」とも呼ばれる。",
            imageNames: [
                "hongakuji-1",
                "hongakuji-2",
                "hongakuji-3",
        ...
        Location(
            ...
            description: "妙隆寺は、神奈川県鎌倉市にある日蓮宗の寺院。鎌倉江の島七福神の一つで「寿老人」を祀る。",
            imageNames: [
                "myoryuji-1",
                "myoryuji-2",
                "myoryuji-3",
